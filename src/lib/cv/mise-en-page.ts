...
export const MESURES = {
  ...
  interligne: 1.26,
  /**
   * L'accroche suivait naguère son propre interligne, et React-PDF lui
   * appliquait plus du double de la valeur demandée. Elle est revenue au
   * régime commun : un seul interligne pour tout le corps du CV.
   */
  interligneAccroche: 1.26,
